...
<head>
    ...
    <title>Guardia POS - Canceled Invoices</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="summary-grid">
            <div class="summary-card">
                <div class="summary-label">Total Canceled Invoices</div>
        ...
        <!-- Invoices Table -->
        <div class="card">
            <h2 class="card-title">Canceled Invoices - <?php 
                $display_filter = ucfirst($filter_type) . ': ' . htmlspecialchars($filter_value); 
                echo $display_filter; 
            ?></h2>
            <?php if (empty($invoices)): ?>
                <div class="no-data">
                    <p>No canceled invoices found for the selected criteria.</p>
                </div>
            <?php else: ?>
                        ...
                        <tbody>
                            <?php foreach ($invoices as $invoice): ?>
                                <tr data-invoice-id="<?php echo htmlspecialchars((int)$invoice['id']); ?>">
                                    ...
                                    <td>
                                        <span class="badge badge-canceled"><?php echo htmlspecialchars($invoice['payment_type'] ?: 'N/A'); ?></span>
                                    </td>
    ...
    <script>
        ...
        document.getElementById('filterForm').addEventListener('submit', function(e) {
            ...
            window.location.href = `canceled.php?filter_type=${filterType}&filter_value=${encodeURIComponent(filterValue)}`;
        });
