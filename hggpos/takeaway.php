...
try {
    ...
    $query = "
        ...
        FROM invoices
        WHERE status != 'canceled' AND payment_type = 'take_away'
    ";
...
<head>
    ...
    <title>Guardia POS - Take Away Invoices</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="summary-grid">
            <div class="summary-card">
                <div class="summary-label">Total Take Away Invoices</div>
        ...
        <!-- Invoices Table -->
        <div class="card">
            <h2 class="card-title">Take Away Invoices - <?php 
                $display_filter = ucfirst($filter_type) . ': ' . htmlspecialchars($filter_value); 
                echo $display_filter; 
            ?></h2>
            <?php if (empty($invoices)): ?>
                <div class="no-data">
                    <p>No take away invoices found for the selected criteria.</p>
                </div>
            <?php else: ?>
    ...
    <script>
        ...
        document.getElementById('filterForm').addEventListener('submit', function(e) {
            ...
            window.location.href = `takeaway.php?filter_type=${filterType}&filter_value=${encodeURIComponent(filterValue)}`;
        });
