...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Normal login
        ...
        $stmt = $conn->prepare("SELECT id, username, password FROM accounts_users WHERE username = ?");
        if ($stmt === false) {
...
<body>
    ...
    <div class="login-container">
        <h1>Login to Accounts Panel</h1>
        
        <?php if ($error): ?>
            <div class="error"><?php echo htmlspecialchars($error); ?></div>
        <?php endif; ?>
        
        <form action="accounts_login.php" method="POST">
