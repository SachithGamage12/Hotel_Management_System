...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($username === $valid_username && $password === $valid_password) {
        ...
        header("Location: admin.php"); // Redirect to admin.php (note: added space after colon for standard syntax)
        exit();
    } else {
        $error = "<p class='text-red-500 text-center mt-4 font-medium'>Invalid username or password.</p>";
    }
}
?>
<!DOCTYPE html>
