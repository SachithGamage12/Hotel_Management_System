...
$lock_result = $conn->query("SELECT is_locked FROM registration_access LIMIT 1");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['unlock_registration'])) {
    ...
    if (!$conn) {
        ...
        if ($username === $admin_username && $password === $admin_password) {
            $update = $conn->prepare("UPDATE registration_access SET is_locked = FALSE");
            if ($update === false) {
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="register-link">
            ...
            <?php else: ?>
                <p>Already have an account? <a href="Backoffice_login.php">Login here</a></p>
            <?php endif; ?>
        </div>
    </div>
