...
<body class="bg-gray-100">
    <div class="container mx-auto p-6">
        ...
        <h1 class="text-3xl font-bold mb-6 text-center text-indigo-800">Main Kitchen Buffer Stock Report</h1>
        ...
        $sql = "SELECT 
                ...
                FROM 
                    inventory i
                    LEFT JOIN kitchen_buffer b ON i.id = b.item_id
                    LEFT JOIN kitchen_buffer_history h ON i.id = h.item_id
                $filter_condition
                ORDER BY 
        ...
        <script>
            ...
            function printTable() {
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        <h1 style="text-align: center; color: #4b0082;">Main Kitchen Buffer Stock Report</h1>
                        ${table}
                    </body>
                    </html>
                `);
