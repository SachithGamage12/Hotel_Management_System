...
try {
    ...
    $tableCheck = $conn->query("SHOW TABLES LIKE 'kitchen_buffer'");
    if ($tableCheck->rowCount() == 0) {
        throw new PDOException("Table 'kitchen_buffer' does not exist in database '$dbname'");
    }
    ...
    error_log("Fetched " . count($buffer_items) . " buffer items for Main Kitchen Buffer Stock Refill at " . date('Y-m-d H:i:s'));
