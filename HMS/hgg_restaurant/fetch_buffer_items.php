...
try {
    ...
    $tableCheck = $conn->query("SHOW TABLES LIKE 'hggkitchen_buffer'");
    if ($tableCheck->rowCount() == 0) {
        throw new PDOException("Table 'hggkitchen_buffer' does not exist in database '$dbname'");
    }
    ...
    error_log("Fetched " . count($buffer_items) . " buffer items for HGG/R Buffer Stock Refill at " . date('Y-m-d H:i:s'));
