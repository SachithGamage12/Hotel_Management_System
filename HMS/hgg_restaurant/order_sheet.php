...
<body class="bg-gradient-to-br from-teal-100 to-blue-200 min-h-screen p-6">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_request'])) {
                ...
                try {
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("INSERT INTO hggorder_sheet (item_id, requested_qty, status, request_date, order_sheet_no, responsible_id, function_type, function_date, day_night) 
                                              VALUES (?, ?, 'pending', NOW(), ?, ?, ?, ?, ?)");
                        foreach ($items as $item) {
                            // Verify item exists
    ...
    <script>
        ...
        searchInput.addEventListener('input', function() {
            ...
            if (functionTypeSelect.value === 'HGG/R Buffer Stock Refill') return; // Skip search for buffer stock
