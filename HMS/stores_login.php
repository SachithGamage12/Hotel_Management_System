...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['unlock_registration'])) {
        ...
        if ($username === $admin_username && $password === $admin_password) {
            ...
            if ($update === false) {
                ...
                header("Location: stores_register.php");
                exit();
            }
        } else {
    ...
    // Normal login
        ...
        $stmt = $conn->prepare("SELECT id, username, password FROM store_users WHERE username = ?");
        if ($stmt === false) {
...
<body>
    ...
    <div class="login-container">
        <h1>Login to Stores Panel</h1>
        
        <?php if ($error): ?>
            <div class="error"><?php echo htmlspecialchars($error); ?></div>
        <?php endif; ?>
        
        <form action="stores_login.php" method="POST">
    ...
    <div class="popup" id="adminPopup">
        <div class="popup-content">
            ...
            <form action="frontoffice_login.php" method="POST">
                <div class="form-group">
