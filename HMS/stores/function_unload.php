...
try {
    ...
    $responsible_stmt = $conn->prepare("SELECT id, name FROM responsible");
...
<head>
    ...
    <title>Function Unload System</title>
    ...
    <div class="container mx-auto max-w-7xl">
        <header class="mb-8">
            <h1 class="text-4xl font-bold text-teal-800 text-center flex items-center justify-center gap-2">
                <i class="fas fa-truck-loading"></i> Function Unload System
            </h1>
        </header>
        ...
        <form method="post" action="" id="unload_form">
            ...
            <div class="card mb-8">
                ...
                <div class="mb-6 bg-gray-50 p-4 rounded-lg shadow-inner">
                    <h3 class="font-bold text-xl mb-3 flex items-center gap-2"><i class="fas fa-info-circle"></i> Function Summary</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-white p-3 rounded shadow-sm">
                            <p><span class="font-medium">Order Sheets:</span> <?php echo htmlspecialchars($function_details['order_sheet_nos']); ?></p>
