        ...
        if (!$conn) {
            ...
            if ($stmt === false) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    // Insert new user
                    $insert = $conn->prepare("INSERT INTO inventory_users (username, password) VALUES (?, ?)");
                    if ($insert === false) {
...
<body>
    ...
    <div class="login-container">
        ...
        <form action="inventory_register.php" method="POST">
        ...
        <div class="register-link">
            ...
            <?php else: ?>
                <p>Already have an account? <a href="inventory_login.php">Login here</a></p>
            <?php endif; ?>
        </div>
    </div>
