...
if (!isset($_SESSION['username'])) {
    header("Location: Mainkitchen_login.php");
    exit();
}
...
<head>
    ...
    <title>Main Kitchen Panel</title>
    ...
    <div class="admin-panel">
        <div class="sidebar">
            ...
            <div class="menu">
                ...
                <div class="menu-item" onclick="window.location.href='Kitchen/order_sheet.php'">
                    <i class="fas fa-shopping-cart"></i>
                    <span>Order Sheet</span>
                </div>
                <div class="menu-item" onclick="window.location.href='Kitchen/kitchen_usage.php'">
                    <i class="fas fa-line-chart"></i>
                    <span>Buffer Stock Update</span>
                </div>
                <div class="menu-item" onclick="window.location.href='stores_logout.php'">
    ...
    <script>
        ...
        function resetInactivityTimer() {
            ...
            inactivityTimeout = setTimeout(() => {
                window.location.href = 'Mainkitchen_logout.php'; // Redirect to logout page
