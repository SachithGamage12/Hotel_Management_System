...
if (!isset($_SESSION['username'])) {
    header("Location: Hgg_restaurant_login.php");
    exit();
}
...
<head>
    ...
    <title>Hgg Restaurant Panel</title>
...
<body>
    <div class="admin-panel">
        <div class="sidebar">
            ...
            <div class="logo">
                <img src="images/Bar Logo PNG.png" alt="Grand Guardian Logo" class="grand-guardian-logo">
            </div>
            <div class="menu">
                ...
                <div class="menu-item" onclick="window.location.href='hgg_restaurant/order_sheet.php'">
                    <i class="fas fa-shopping-cart"></i>
                    <span>Order Sheet</span>
                </div>
                <div class="menu-item" onclick="window.location.href='hgg_restaurant/hggkitchen_usage.php'">
                    <i class="fas fa-line-chart"></i>
                    <span>Buffer Stock Update</span>
                </div>
                <div class="menu-item" onclick="window.location.href='Hgg_restaurant_logout.php'">
    ...
    <script>
        ...
        function resetInactivityTimer() {
            ...
            inactivityTimeout = setTimeout(() => {
                window.location.href = 'Hgg_restaurant_logout.php'; // Redirect to logout page
