...
<body>
    ...
    <script>
        ...
        function printPO() {
            ...
            const poDate = '<?php echo date('d-M-Y H:i', strtotime($po['created_at'])); ?>';
            const supplierName = '<?php echo addslashes(htmlspecialchars($po['supplier_name'] ?? 'N/A')); ?>';
            const supplierContact = '<?php echo addslashes(htmlspecialchars($po['supplier_contact'] ?? 'N/A')); ?>';
            const supplierAddress = '<?php echo addslashes(htmlspecialchars($po['supplier_address'] ?? 'N/A')); ?>';
            const requestedBy = '<?php echo addslashes(htmlspecialchars($po['requested_by_name'] ?? 'N/A')); ?>';
            const confirmedBy = '<?php echo addslashes(htmlspecialchars($po['confirmed_by_name'] ?? 'N/A')); ?>';
            ...
            console.log("Print data:", { poNumber, poDate, supplierName, supplierContact, supplierAddress, requestedBy, confirmedBy, itemsHtml });
                ...
                <body>
                    <div class='po-container'>
                        ...
                        <div class='supplier-info'>
                            ...
                            <div><strong>Contact:</strong> ${supplierContact}</div>
                            <div><strong>Address:</strong> ${supplierAddress}</div>
                        </div>
                        <table class='table'>
                            <thead>
                                <tr>
            ...
            setTimeout(function () {
                if (typeof qz === 'undefined') {
                    ...
                    setTimeout(() => {
                        ...
                        console.log("Redirecting to create_po.php after window.print.");
                        window.location.href = 'create_po.php';
                    }, 5000);
                    return;
                }
                ...
                qz.websocket.connect().then(function () {
                    ...
                    return qz.printers.find("POSPrinter POS-80C").catch(function(err) {
                        ...
                        setTimeout(() => {
                            console.log("Hiding print error after 5 seconds.");
                            printError.style.display = 'none';
                            console.log("Redirecting to create_po.php after printer not found.");
                            window.location.href = 'create_po.php';
                        }, 5000);
                        throw err;
                    });
                    ...
                    console.log("Redirecting to create_po.php after successful print.");
                    window.location.href = 'create_po.php';
                    ...
                    setTimeout(() => {
                        console.log("Hiding print error after 5 seconds.");
                        printError.style.display = 'none';
                        console.log("Redirecting to create_po.php after print error.");
                        window.location.href = 'create_po.php';
                    }, 5000);
                });
            }, 500);
