...
if (isset($_POST['submit_request'])) {
    ...
    } elseif (empty($last_request_date)) {
        $error = 'Last request date is required.';
                ...
                if (password_verify($manager_password, $manager['password'])) {
                    ...
                    try {
                        ...
                        foreach ($items as $item) {
                            ...
                            $quantity = floatval($item['quantity']); // Use floatval to handle decimals
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    <label for="last_request_date" class="form-label">Date of Last Request</label>
                    <input type="date" class="form-control" id="last_request_date" name="last_request_date" required>
                </div>
                <div class="mb-3">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('form').on('submit', function(e) {
                ...
                if (!$('#last_request_date').val()) {
                    alert('Last request date is required.');
                    valid = false;
                }
                if (!$('#manager_id').val()) {
