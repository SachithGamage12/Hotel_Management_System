...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <button onclick="window.location.href='../inventory.php'" style="background-color: #e6451dff; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; margin-right: 50px;">
            Back
        </button>
    </nav>
