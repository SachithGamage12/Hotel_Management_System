...
// =========================
$host = "localhost"; 
$db   = "hotelgrandguardi_wedding_bliss";   // <-- change this
$user = "hotelgrandguardi_root";         // <-- change this
$pass = "Sun123flower@";     // <-- change this
$charset = "utf8mb4";
    ...
    if (!isset($_POST["csrf"]) || !hash_equals($_SESSION["csrf"], $_POST["csrf"])) {
        ...
        if (!$errors) {
            try {
                ...
                $stmt = $conn->prepare("INSERT INTO logistics_users (name, password) VALUES (:n, :p)");
