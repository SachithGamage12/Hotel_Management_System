...
<body>
    <div class="request-sheet">
        <a href="../order.php" class="btn btn-secondary back-button">Back</a>
        <?php if ($error): ?>
        ...
        <?php elseif ($request_data): ?>
            ...
            <button onclick="downloadAsJPG()" class="btn btn-secondary download-button">Download as JPG</button>
        <?php endif; ?>
    </div>
    ...
    <script>
        function downloadAsJPG() {
            ...
            const element = document.querySelector('.request-sheet');
            html2canvas(element, {
                ...
                link.download = `request_sheet_${<?php echo json_encode($request_id); ?>}.jpg`;
                link.href = canvas.toDataURL('image/jpeg', 0.9); // Quality set to 0.9
                link.click();
            }).catch(error => {
