...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['unlock_registration'])) {
        ...
        if ($username === $admin_username && $password === $admin_password) {
            ...
            if ($update === false) {
                ...
                header("Location: hgg_restaurant_register.php");
                exit();
            }
        } else {
    ...
    // Normal login
        ...
        $stmt = $conn->prepare("SELECT id, username, password FROM hggkitchen_users WHERE username = ?");
        if ($stmt === false) {
            ...
            if ($result->num_rows === 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    header("Location: hgg_restaurant.php");
                    exit();
                } else {
...
<body>
    ...
    <div class="login-container">
        <h1>Login to Hgg Restaurant Panel</h1>
        
        <?php if ($error): ?>
            <div class="error"><?php echo htmlspecialchars($error); ?></div>
        <?php endif; ?>
        
        <form action="Hgg_restaurant_login.php" method="POST">
