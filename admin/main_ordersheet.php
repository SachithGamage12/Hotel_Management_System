...
$function_types_query = "SELECT DISTINCT function_type FROM order_sheet WHERE function_type != '' ORDER BY function_type";
...
if ($export === 'csv') {
    ...
    header('Content-Disposition: attachment; filename="kitchen_order_report_' . $start_date . '_to_' . $end_date . '.csv"');
    ...
    fputcsv($output, [
        ...
        'Request Date', 'Responsible Person'
    ]);
...
<head>
    ...
    <title>Kitchen Order Sheet Report</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
  ...
  >
    ...
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1>Kitchen Order Sheet Report</h1>
