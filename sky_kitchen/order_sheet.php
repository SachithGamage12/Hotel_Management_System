...
<body class="bg-gradient-to-br from-teal-100 to-blue-200 min-h-screen p-6">
    ...
    <div class="container mx-auto max-w-6xl bg-white p-10 rounded-3xl shadow-2xl">
        <h2 class="text-4xl font-bold text-teal-900 mb-10 text-center">Create SKY Order Sheet</h2>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_request'])) {
                ...
                try {
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("INSERT INTO skyorder_sheet (item_id, requested_qty, requested_unit, status, request_date, order_sheet_no, responsible_id, function_type, function_date, day_night) 
                                              VALUES (?, ?, ?, 'pending', NOW(), ?, ?, ?, ?, ?)");
            ...
            foreach ($pending_requests as $request) {
                ...
                if (!isset($grouped_requests[$order_sheet_no])) {
                    $grouped_requests[$order_sheet_no] = [
                        ...
                        'responsible_name' => $request['responsible_name'] ?? 'N/A',
        ...
        <div id="print-view" style="display: none;">
            <div class="header">SKY Kitchen Order Sheet</div>
    ...
    <script>
        ...
        searchInput.addEventListener('input', function() {
            ...
            if (functionTypeSelect.value === 'SKY Buffer Stock Refill') return;
