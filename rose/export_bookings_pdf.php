...
class PremiumTCPDF extends TCPDF {
    public function Header() {
        ...
        $logoPath = __DIR__ . '/../image/rose logo png.png';
        ...
        $this->SetXY(50, 10);
        $this->Cell(0, 10, 'Hotel Rose Garden', 0, 1, 'L', 0, '', 0);
    ...
    public function Footer() {
        ...
        $this->SetY(-12);
        $this->Cell(80, 6, 'Hotel Rose Garden- Confidential Report', 0, 0, 'L', 0, '', 0);
