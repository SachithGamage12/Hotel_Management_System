...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO sapthapadhiguests (
        grc_number, guest_name, contact_number, email, address, id_type, id_number,
        check_in_date, check_in_time, check_in_time_am_pm,
        check_out_date, check_out_time, check_out_time_am_pm,
        rooms, meal_plan_id, number_of_pax, remarks
    ) VALUES (
        :grc_number, :guest_name, :contact_number, :email, :address, :id_type, :id_number,
        :check_in_date, :check_in_time, :check_in_time_am_pm,
        :check_out_date, :check_out_time, :check_out_time_am_pm,
