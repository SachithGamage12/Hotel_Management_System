...
<body class="min-h-screen flex flex-col">
  ...
  <div class="sidebar" id="sidebar">
    ...
    <button onclick="openAddModal('flower_decorations', 'Add New Flower Decoration')">Add Flower Decoration</button>
    <button onclick="openAddModal('car_decorations', 'Add New Car Decoration')">Add Car Decoration</button>
    <button onclick="openAddModal('milk_fountains', 'Add New Milk Fountain')">Add Milk Fountain</button>
    <button onclick="openAddModal('champagnes', 'Add New Champagne')">Add Champagne</button>
    <button onclick="openAddModal('cultural_tables', 'Add New Cultural Table')">Add Cultural Table</button>
    <button onclick="openAddModal('kiribath_structures', 'Add New Kiribath Structure')">Add Kiribath Structure</button>
    <button onclick="openAddModal('cake_structures', 'Add New Cake Structure')">Add Cake Structure</button>
  </div>
      ...
      <div class="form-container w-full max-w-5xl p-10 flex flex-col gap-10 animate-fadeInUp">
        ...
        <div id="page1" class="form-page">
          ...
          <form id="booking-form" class="grid grid-cols-2 gap-8">
            <div class="form-group" style="--index: 1">
              ...
              <input type="text" id="name" name="full_name" placeholder="Enter Full Name" class="w-full" required>
            </div>
            <div class="form-group" style="--index: 2">
              <label class="text-sm font-medium text-purple-900">Contact Numbers</label>
              <div class="flex gap-4">
                <input type="tel" id="contact_no1" name="contact_no1" placeholder="Primary Contact Number" class="w-full" required>
            ...
            <div class="form-group" style="--index: 5">
              ...
              <input type="text" id="couple_name" name="couple_name" placeholder="Enter Couple Name" class="w-full" required>
            </div>
            <div class="form-group col-span-2" style="--index: 6">
              <label class="text-sm font-medium text-purple-900">Addresses</label>
              <div class="flex gap-4">
                <input type="text" id="groom_address" name="groom_address" placeholder="Groom's Address" class="w-full" required>
                <input type="text" id="bride_address" name="bride_address" placeholder="Bride's Address" class="w-full" required>
              </div>
            </div>
          ...
          <form id="additional-form" class="grid grid-cols-2 gap-8">
            ...
            <div class="form-group" style="--index: 2">
              ...
              <div class="time-group">
                ...
                <select name="bride_arrival_nakatha" class="border rounded-lg w-32">
                  <option value="">Select Nakatha</option>
                  <option value="Nakatha">Nakatha</option>
                </select>
              </div>
            </div>
            <div class="form-group" style="--index: 3">
              ...
              <div class="time-group">
                ...
                <select name="groom_arrival_nakatha" class="border rounded-lg w-32">
                  <option value="">Select Nakatha</option>
                  <option value="Nakatha">Nakatha</option>
                </select>
              </div>
            ...
            <div class="form-group col-span-2" style="--index: 4">
              ...
              <div class="time-range-group">
                ...
                <div class="time-subgroup">
                  ...
                  <select name="morning_tea_nakatha" class="border rounded-lg w-32">
                    <option value="">Select Nakatha</option>
                    <option value="Nakatha">Nakatha</option>
                  </select>
                </div>
          ...
          <form id="logistics-form" class="grid grid-cols-2 gap-8">
            ...
            <div class="form-group" style="--index: 4">
              ...
              <select id="bites_source" name="bites_source" class="w-full">
                ...
                <option value="H.G.G">H.G.G</option>
                <option value="Customer">Customer</option>
                <option value="H.G.G & Customer">H.G.G & Customer</option>
              </select>
            </div>
            ...
            <div class="form-group" style="--index: 6">
              ...
              <div class="time-group">
                ...
                <select name="buffet_open_nakatha" class="border rounded-lg w-32">
                  <option value="">Select Nakatha</option>
                  <option value="Nakatha">Nakatha</option>
                </select>
              </div>
            ...
            <div class="form-group" style="--index: 7">
              ...
              <div class="time-group">
                ...
                <select name="buffet_close_nakatha" class="border rounded-lg w-32">
                  <option value="">Select Nakatha</option>
                  <option value="Nakatha">Nakatha</option>
                </select>
              </div>
            ...
            <div class="form-group" style="--index: 11">
              ...
              <div class="time-group">
                ...
                <select name="departure_time_nakatha" class="border rounded-lg w-32">
                  <option value="">Select Nakatha</option>
                  <option value="Nakatha">Nakatha</option>
                </select>
              </div>
        ...
        <div id="page4" class="form-page hidden">
          ...
          <form id="cultural-decor-form" action="save_booking.php" method="POST" class="grid grid-cols-2 gap-8">
            ...
            <div class="form-group" style="--index: 22">
            ...
            <div class="form-group" style="--index: 23">
              <label for="flower_decoration" class="text-sm font-medium text-purple-900">Flower Decoration</label>
              <select id="flower_decoration" name="flower_decoration_id" class="w-full">
                <option value="" disabled selected>Select Flower Decoration</option>
              </select>
            </div>
            <div class="form-group" style="--index: 24">
              <label for="car_decoration" class="text-sm font-medium text-purple-900">Car Decoration</label>
              <select id="car_decoration" name="car_decoration_id" class="w-full">
                <option value="" disabled selected>Select Car Decoration</option>
              </select>
            </div>
            <div class="form-group" style="--index: 25">
              <label for="milk_fountain" class="text-sm font-medium text-purple-900">Milk Fountain</label>
              <select id="milk_fountain" name="milk_fountain_id" class="w-full">
                <option value="" disabled selected>Select Milk Fountain</option>
              </select>
            </div>
            <div class="form-group" style="--index: 26">
              <label for="champagne" class="text-sm font-medium text-purple-900">Champagne</label>
              <select id="champagne" name="champagne_id" class="w-full">
                <option value="" disabled selected>Select Champagne</option>
              </select>
            </div>
            <div class="form-group" style="--index: 27">
              <label for="cultural_table" class="text-sm font-medium text-purple-900">Cultural Table</label>
              <select id="cultural_table" name="cultural_table_id" class="w-full">
                <option value="" disabled selected>Select Cultural Table</option>
              </select>
            </div>
            <div class="form-group" style="--index: 28">
              <label for="kiribath_structure" class="text-sm font-medium text-purple-900">Kiribath Structure</label>
              <select id="kiribath_structure" name="kiribath_structure_id" class="w-full">
                <option value="" disabled selected>Select Kiribath Structure</option>
              </select>
            </div>
            <div class="form-group" style="--index: 29">
              <label for="cake_structure" class="text-sm font-medium text-purple-900">Cake Structure</label>
              <select id="cake_structure" name="cake_structure_id" class="w-full">
                <option value="" disabled selected>Select Cake Structure</option>
              </select>
            </div>
            <div class="form-group" style="--index: 30">
            ...
            <div class="form-group col-span-2" style="--index: 34">
              <label for="additional_notes" class="text-sm font-medium text-purple-900">Additional Notes</label>
              <textarea id="additional_notes" name="additional_notes" placeholder="Any additional notes or special requests" class="w-full"></textarea>
            </div>
            <div class="flex gap-4 col-span-2">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      timeInputs.forEach(input => {
        input.addEventListener('change', function() {
          ...
          const amPmSelect = this.parentElement.querySelector('select[name$="_am_pm"]');
          if (amPmSelect) {
      ...
      populateSelect('flower_decoration', 'flower_decorations');
      populateSelect('car_decoration', 'car_decorations');
      populateSelect('milk_fountain', 'milk_fountains');
      populateSelect('champagne', 'champagnes');
      populateSelect('cultural_table', 'cultural_tables');
      populateSelect('kiribath_structure', 'kiribath_structures');
      populateSelect('cake_structure', 'cake_structures');
    });
    // Show first page
    function showPage1() {
    ...
    // Show second page with validation for page 1
    function showPage2() {
