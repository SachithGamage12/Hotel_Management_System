            ...
            <div class="menu">
                ...
                <div class="menu-item" onclick="window.location.href='Grc.php'">
                    ...
                    <span>GRC Form</span>
                                ...
                                <div class="menu-item" onclick="window.location.href='edit_grc.php'">
                    <i class="fas fa-address-book"></i>
                    <span>Edit GRC Form</span>
                </div>
                <div class="menu-item" onclick="window.location.href='foroom _bill.php'">
                    <i class="fas fa-calculator"></i>
                    <span>Room Billing</span>
                </div>
                                <div class="menu-item" onclick="window.location.href='search_advance_invoice.php'">
                    <i class="fas fa-credit-card-alt"></i>
                    <span>Advance Invoice View</span>
                </div>
                <div class="menu-item" onclick="window.location.href='view_foroom_bill.php'">
                    <i class="fas fa-credit-card-alt"></i>
                    <span>Room Invoice View</span>
                </div>
                <div class="menu-item" onclick="window.location.href='fn_cancel_bill.php'">
                    <i class="fa-solid fa-ban"></i>
                    <span>Cancel Room Bill</span>
                </div>
                <div class="menu-item" onclick="window.location.href='cancel_advance.php'">
                    <i class="fa-solid fa-ban"></i>
                    <span>Cancel Room Advance Bill</span>
                </div>
