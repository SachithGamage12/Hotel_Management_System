                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="category" name="category" required>
                                ...
                                <option value="Fish & Meat Items">Fish & Meat Items</option>
                                                            ...
                                                            <div class='mb-3'>
                                                                ...
                                                                <select class='form-select' id='unit{$row['id']}' name='unit' required>
                                                                    ...
                                                                    <option value='packet'" . ($row['unit'] == 'packet' ? ' selected' : '') . ">Packet</option>
                                                                     <option value='can'" . ($row['unit'] == 'can' ? ' selected' : '') . ">Can</option>
                                                                     <option value='tub'" . ($row['unit'] == 'tub' ? ' selected' : '') . ">Tub</option>
                                                                     <option value='bottle'" . ($row['unit'] == 'bottle' ? ' selected' : '') . ">Bottle</option>
