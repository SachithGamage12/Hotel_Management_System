...
$main_dbname = "hotelgrandguardi_wedding_bliss";
...
try {
    ...
    $conn_main = new PDO("mysql:host=$servername;dbname=$main_dbname", $username, $password);
    ...
    $unload_stmt = $conn_history->prepare("
        ...
        FROM function_unload_history fuh
        LEFT JOIN $main_dbname.storeresponsible r ON fuh.created_by = r.id
    ...
    // Get item names from the main database
    ...
    error_log($error_message); // Log error to server logs
}
?>
...
<head>
    ...
    <title>Main Kitchen Unload History</title>
    ...
    <div class="container mx-auto max-w-7xl">
        <header class="mb-8">
            <h1 class="text-4xl font-bold text-teal-800 text-center flex items-center justify-center gap-2">
                <i class="fas fa-history"></i>Main Kitchen Unload History
            </h1>
        </header>
